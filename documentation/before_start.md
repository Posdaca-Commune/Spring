...
## 制作Mod前的准备工作
### 下载文本编辑器
制作mod所常用的文本编辑器有[VS code](https://code.visualstudio.com "点击前往官网")（以下简称VSC）与[Intellij IDEA](https://www.jetbrains.com/zh-cn/pycharm "点击前往官网")（以下简称IDEA）。
...
2. 在**模组依赖**一栏添加其他Mod以同时建立索引（可选，通常用于制作附属Mod时使用）。
